...
let MongooseService = class MongooseService {
    ...
    update(entry, fields = this.defaultQueryFields) {
        return __awaiter(this, void 0, void 0, function* () {
            const instance = yield this.model.findOneAndUpdate({ _id: entry._id }, { $set: entry }, { upsert: true, fields: this.getFields(fields), 'new': true }).exec();
            return instance;
        });
    }
    query(index = 1, size = 10, query = {}, searchField = 'name', fields = this.defaultQueryFields, sort = { _id: 1 }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
                let result = {
                    list: yield listQuery.limit(size).skip(size * (index - 1)).lean(),
    ...
    remove(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.model.remove(entity);
        });
    }
    getFields(fields) {
        const selectFields = {};
